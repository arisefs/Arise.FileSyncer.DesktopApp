...
import { ReceivedProfile, ReceivedProfileResult } from "../../../../main/ipc/messages";
...
export class ReceivedProfilePage extends React.Component<ReceivedProfile.Data, ReceivedProfilePageState> {
    ...
    private connectionName: string = "Unknown";
    ...
    constructor(props: ReceivedProfile.Data) {
        ...
        if (AppData.connections.containsKey(this.props.ConnectionId)) {
            let connection = AppData.connections.get(this.props.ConnectionId);
            if (connection != null) {
    ...
    private onAccept() {
        ...
        if (checkEditorState(this)) {
            let resultData: ReceivedProfileResult.Data = {
            ...
            ipcRenderer.send("accept-profile", resultData);
